...
def main() -> int:
    ...
    if '"live_before_hash_gate": False' in updated:
        raise RuntimeError("false_gate_survived")
    if '"live_before_hash_gate": True' not in updated:
        raise RuntimeError("true_gate_missing")
    for required in (
