...
out={'schema':'eira2_prestart_milestone_probe_v2','ok':False,'mutates_live':False,'milestones':[]}
def step(name,fn):
    t=time.monotonic()
    try:
...
try:
    from eira2.live import live_config, _verified_live_identity, verify_response
